...
RCSID("$Id: getrealm.c,v 1.34 1998/07/22 11:42:36 assar Exp $");
...
{
	if (krb_registry_read("krb.realms", phost, ret_realm, ret_realm_sz))
		return 0;

	if (krb_registry_read("krb.realms", domain, ret_realm, ret_realm_sz))
		return 0;
